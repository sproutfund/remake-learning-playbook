...
- **Guest Posts**: Network members contribute posts to the Remake Learning blog when they return from conferences, publish a new report, or discover something they want the whole network to know about.
- **Digest & Translate**: Blog editors survey current trends and topics of discussion in the ongoing global conversation about learning and education, then relate those concepts and ideas to concrete examples happening in Pittsburgh.
- **Unpacking Ideas**: Remake Learning runs an ongoing series of blog posts that examine specific approaches to learning that might be poorly understood, such as Blended Learning, Flipped Learning, Connected Learning, and 21st Century Learning.
...
- **Hand Over Accounts**: Remake Learning Network members are given access to the network’s twitter account @remakelearning, like when Dror Yaron of the CREATE Lab represented the network at the International Democratic Education Conference.
- **Join The Conversation**: Remake Learning regularly participates in twitterchats like the worldwide #EdChat as well as locally focused conversations like #AfterschoolMatters hosted by network member APOST, Pittsburgh’s afterschool support agency.
- **Hashtag Campaigns**: Remake Learning adopts hashtags that relate to its focus areas, like #PghSummerRocks to promote summer learning, #ConnectedEd to recognize teachers during connected educator month, and #TeachtheWeb to advocate for digital and web literacy.
- **Virtual Conference Participation**: You don’t need to actually attend national conferences in order to participate. Remake Learning adds its voice to online conversations happening at events like Games for Change, SXSWedu, and others.
...
- **Speaking Opportunities**: The Sprout Fund provided conference stipends to several Remake Learning Network members who had secured speaking opportunities at the annual Digital Media & Learning Conference in June 2015.
- **Major National Events**: Elizabeth Forward School District Assistant Superintendent Todd Keruskin utilized a conference stipend from The Sprout Fund to share the story of his district’s transformation with other educators and innovators at the annual SXSWedu event in Austin, TX. South Fayette School District organized a Remake Learning feature event at ISTE 2015, creating opportunities for district educators and other network representatives to engage thousands of ISTE attendees in Remake Learning workshops.
- **Showcase Opportunities**: Remake Learning Network members are supported to exhibit their innovative approaches to learning at signature showcase events like the National Maker Faire in Washington, D.C., where the Children’s Innovation Project, CREATE Lab, Digital Corps, and MAKESHOP created a strong Pittsburgh presence.
...
- **People**: Members of the Remake Learning Network use the people directory to share what they’ve been working on, find potential partners, and learn about members of the network they haven’t met yet.
- **Projects**: A portfolio of project profiles provides basic details, contact info, and relevant links to help users find remarkable learning experiences for children and youth in the Greater Pittsburgh Region.
- **Organizations**: An index of organizations that make up the Remake Learning Network, representing the range of public and private institutions, for profit companies and nonprofit agencies that add strength to the network.
- **Opportunities**: A calendar of events, activities, and opportunities for network members helps people connect with one another face-to-face, sign up for professional development and other training sessions, and find conferences to attend.
...
- **Hear Me Project**: Hear Me interviewed more than 100 Pittsburgh students about youth-police relations, then partnered with youth advocacy organization Allies for Children to share these interviews with Pittsburgh Mayor Bill Peduto as he searched for the city’s next Chief of Police.
- **Pgh Youth Media**: SLB Radio recruits high school students interested in investigative journalism, documentary filmmaking, and radio broadcasting, then matches them with media professionals who act as mentors as the youth publish stories to their own digital news publication.
- **Youth Advisors**: Teen programs like The Labs @ CLP build youth voice into the governance structure of their programs by seating advisory councils and decisionmaking bodies made up of the youth they serve.
- **Tech Warriors**: Neighborhood Learning Alliance hires African American high school students and trains them to become STEM learning mentors for elementary school students, empowering the teens and giving the younger kids role models they can relate to.
...
- **Surveys**: Remake Learning uses its newsletter as a mechanism for gathering input from network members by issuing an annual survey to gauge the effectiveness of its network-building strategies.
- **News**: To build its weekly newsletter, the Remake Learning Network subscribes to a wide range of news sources, feeds, and aggregators to surface the most relevant news stories about learning innovation both locally and nationally.
- **Reports**: To keep network members informed and current, the Remake Learning newsletter highlights important publications like the Ed-Tech Devleoper’s Guide released by the U.S. Department of Education, or the Aspen Institute report on learning and the internet.
...
- **Photography & Video & Audio**: It would be impossible tell the story of a place like Elizabeth Forward School District without photo essays and video featurettes to capture the district’s transformation visually.
- **Profiles**: To introduce new network members, Remake Learning writes brief profiles that are featured on the network’s home page so other members can get to know their peers.
- **Reporting & Feature Stories**: Field reporting creates blanket coverage of the many small-scale innovative projects emerging from the Remake Learning Network and creates useful content for the blog, presentations, and media outreach.
- **Infographics**: Visualizations help make complex ideas easily comprehensible, whether visualizing the impact of an individual project or creating a ready reference for practitioners like the Mindful Makers poster created by Remake Learning Network Member and University of Pittsburgh associate professor Leanne Bowler.
...
- **Funding Announcements**: Money grabs people’s attention. Remake Learning has consistently drawn media coverage when announcing STEAM Grants to regional school districts, and when receiving major investments from national funders like the MacArthur Foundation.
- **Event Hooks**: Public events, especially those that directly engage children and youth in creative, hands-on, and visually rich activities like the Pittsburgh Maker Party, are great for attracting local TV stations and newspapers.
- **Launching New Campaign**: News has to be new. When Pittsburgh City of Learning launched in 2014 with the promise of engaging thousands of youth in innovative summer programming, local media recognized the news value of the initiative.
- **Timing the News Cycle**: Rather than pitching stories that lead with complex ideas about the future of learning, identify topics already in the local news cycle and show your press contacts how your network can move the needle on those issues.
- **Human Interest**: There’s nothing like a personal story to demonstrate the impact of your work, like Pittsburgh teenager Caroline Combemale who went from attending digital learning workshops at The Labs @ CLP to interning at Assemble, to leading her own peer-to-peer digital learning program.
...
- **State of the Network Report**: Remake Learning issues an annual ’State of the Network Report’ that records the growth and evolution of the network, recognizes major developments and accomplishments, and summarizes the results of the annual network survey.
- **University Press**: CREATE Lab Director Dr. Illah Nourbakhsh published *Robot Futures* through MIT Press, exploring how new technologies will shape the future of life and work, and the opportunities communities have to shape this next evolution of society for the best.
- **Teaching Kits**: The Digital Corps publishes Teaching Kits developed with contributions from a variety of network members to share locally-developed programming as a Remake Learning contribution to the international movement to #teachtheweb.
...
- **Innovation Tours**: Elizabeth Forward School District hosts regular monthly tours of its school, attracting visitors from more than 100 school districts throughout the country to see how district leaders, educators, facility staff, and students are all contributing to a transformed school environment.
- **User Communities**: BirdBrain Technologies maintains online forums to build virtual communities of teachers across the country as a way to grow its user and customer base organically, and also serve up examples of how Remake Learning Network members are using their education technology products.
- **Expert Consultation**: When the Obama Administration wanted to host the first ever White House Maker Faire, The Children’s Museum of Pittsburgh shared the lessons learned they’ve learned in MAKESHOP and were recognized for their leadership in maker education.
- **For Attribution**: Remake Learning Network members with expertise in particular fields are served up to writers and reporters seeking quotes from authoritative sources, such as CREATE Lab director Dr. Illah Nourbakhsh in robotics or Dr. Junlei Li of the Fred Rogers Center in early childhood learning.

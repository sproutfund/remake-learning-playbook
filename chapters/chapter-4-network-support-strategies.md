...
- [Convene](#convene) a community of practice;
- [Catalyze](#catalyze) innovative learning projects;
- [Communicate](#communicate) within and outside the network;
- [Coordinate](#coordinate) network members to maximize impact; and,
- [Champion](#champion) the network’s accomplishments.
...
> For more detailed step-by-step instructions for implementing plays based on these strategies, see the [Plays in Detail](../plays-in-detail.md) section near the end of the Playbook.
...
*See detailed instructions for implementing these and other convening strategies in [Plays in Detail](../plays/convene.md).*
...
*See detailed instructions for implementing these and other catalytic strategies in [Plays in Detail](../plays/catalyze.md).*
...
*See detailed instructions for implementing these and other communications strategies in [Plays in Detail](../plays/communicate.md).*
...
*See detailed instructions for implementing these and other coordination strategies in [Plays in Detail](../plays/coordinate.md).*
...
*See detailed instructions for implementing these and other champion strategies in [Plays in Detail](../plays/champion.md).*

---

*Add your comments and feedback about this chapter on [Medium](https://medium.com/remake-learning-playbook/our-strategies-d79c5b7f23cd).*

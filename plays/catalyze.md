...
- **STEAM Grants**: The Allegheny Intermediate Unit distributes grants of up to $20,000 to support classroom innovation in nearly 30 Pittsburgh-area school districts.
- **Hive Grants**: Avonworth High School used a Hive Grant from The Sprout Fund to catalyze a Connected Learning project that had students partnering with museum professionals to plan, curate, and execute an art show in their school.
- **Spark Grants**: The Children’s Innovation Project used a Spark Grant from The Sprout Fund to formalize work they had piloted to create interdisciplinary technology programming for kindergarten students.
...
- **Mentorship**: The Sprout Fund matches newly funded projects with leaders of past successful projects to offer guidance and advice on common challenges facing man small-scale pilot initiatives.
- **Info Sessions**: The Sprout Fund hosts monthly workshops for prospective grant applicants to help them understand funding criteria, partner with network members, and develop their ideas into more competitive grant applications.
- **Fiscal Sponsorship**: Nonprofit organizations like PAEYC provide fiscal sponsorship for individuals and unincorporated groups seeking grants, like TekStart, an afterschool program for African-American youth to develop career-oriented tech skills.
- **Toolkits & Guides**: The Digital Corps developed teaching kits to share with other afterschool programs in the network interested in using free and openly available tech learning tools to offer digital literacy programming for tweens and teens.
...
- **Junior Fellows**: The Fred Rogers Center provides Early Career Fellowships for young professionals and graduate students interested in making a career in early childhood learning and children’s media.
- **Design Fellows**: The University of Pittsburgh Center for Learning in Out-of-School Environments (UPCLOSE) embedded design researchers in network sites like Assemble and the Carnegie Museum of Natural History to help OST educators improve programming.
- **Practice Fellows**: The Sprout Fund provided fellowships to graduate students and academic researchers to dive deeply into specific practices of local learning innovators, like maker education and youth media production.
...
- **Recipes for Remarkable Learning**: The Sprout Fund issued a call for Remake Learning Network members to turn successful projects into lesson plans other educators can remix to introduce innovative learning practices in their classrooms.
- **City of Learning**: Pittsburgh City of Learning offered small grants to organizations who responded to a request for proposals demonstrating how they would use digital badges to recognize learning in their summer programs.
- **Learning Through Play**: To focus the Remake Learning Network’s attention on the uses of play for learning, The Sprout Fund offered grants of up to $50,000 to support new and innovative approaches to play-based learning led by regional collaboratives.
- **Transforming the Learning Space**: The Allegheny Intermediate Unit has used its annual STEAM Grants opportunity to support innovative learning practices in Pittsburgh-area school districts to encourage school leaders to re-design classrooms, libraries, and other spaces for 21st century learning.
...
- **Playtesting**: MAKESHOP at The Children’s Museum has been the site for ed-tech developers to test their prototype products, assisted by the museum educators and learning researchers who staff the museum exhibit.
- **Contests**: The Forbes Funds partnered with BNY Mellon to launch UpPrize, a competitive funding opportunity offering awards of up to $1 million to support Pittsburgh entrepreneurs focusing on solving social challenges, including education innovation.
- **Start Up Accelerator**: After developing a prototype puzzle-based programming game for kids in MAKESHOP, Digital Dream Labs went through the AlphaLab start up accelerator program to launch their first product Puzzlets.
...
- **MacArthur Foundation**: Leveraging the network’s strength in digital media and learning initiatives, The Sprout Fund secured support from the MacArthur Foundation to support the launch of Hive Pittsburgh.
- **IMLS**: The Children’s Museum of Pittsburgh built a reputation for rigorous and thoughtful development of maker learning practices in its MAKESHOP exhibit and secured supports from the Institute of Museum & Library Services to share their findings nationwide.
- **Wallace**: Pittsburgh Public Schools secured support from the Wallace Foundation to support the district’s Summer Dreamers Academy, connecting the program to the national emphasis on summer enrichment.
- **Gates**: Pittsburgh Public Schools was one of six recipients of major funding from the Bill & Melinda Gates Foundation to support new methods of recruiting, developing, and evaluating educators.

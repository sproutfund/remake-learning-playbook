...
- [**Assemble—Educational Philosophy**](https://web.archive.org/web/20150919072029/http://assemblepgh.org/about/philosophy/): An overview of Assemble’s principles and reasoning.
...
- [**Learning Space Toolkit**](https://web.archive.org/web/20151109202940/http://learningspacetoolkit.org/): A free resource for planning learning spaces; developed by the North Carolina State University Libraries.
- [**Center for Youth Program Quality**](https://web.archive.org/web/20151024070026/http://www.cypq.org/): A Michigan organization committed to helping programs enhance the experiences they provide for youth.
...
- [**Artists Image Resource**](https://www.airpgh.org/): An artist-run, nonprofit printmaking studio whose purpose is to integrate the creation of fine art printwork with innovative educational programs.
- [**Center of Life**](https://www.centeroflife.org/): A faith-based community empowerment organization whose mission is to provide families and youth with life-skills, education, training, and resources.

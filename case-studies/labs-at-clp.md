...
>
> — Maura Marx, Deputy Director, [Institute of Museum and Library Services](http://www.imls.gov/)
...
In addition to creating its own original workshops, The Labs coordinates programming with other [Remake Learning Network](http://remakelearning.org) members to host guest sessions in its spaces, expanding the range of program choices teens have, and also helping partner programs raise their level of exposure in the community.

The Labs has hosted fine arts programming from the [Carnegie Museum of Art](http://remakelearning.org/organization/carnegie-museums/carnegie-museum-art/) and [Mattress Factory](http://remakelearning.org/organization/mattress-factory/) contemporary art gallery, media production tutorials from [Pittsburgh Filmmakers](http://remakelearning.org/organization/pittsburgh-filmmakers/) and [Hip Hop on L.O.C.K.](http://remakelearning.org/project/hip-hop-on-lock/), and maker workshops from [TechShop](http://remakelearning.org/organization/techshop-pittsburgh/).
...
If you’re interested in learning more about The Labs, contact [Corey Wittig](http://remakelearning.org/person/wittig-corey/).
...
- [**Urban Libraries Council**](http://www.urbanlibraries.org/): Membership association of public library systems that advances the value of libraries to provide 21st century educational opportunities.
...
- [**Carnegie of Homestead Library**](http://carnegieofhomestead.com/library/kids-teens/): A public library in the Homestead neighborhood of Pittsburgh with programming and resources specifically curated for kids and teens, including digital learning and making.
- [**Millvale Community Library**](http://www.millvalelibrary.org/): A public library in the Millvale neighborhood of Pittsburgh that aims to be a powerhouse of local involvement and curates programming and resources for kids and teens.
...
- [**Elizabeth Forward Media Center**](http://remakelearning.org/project/elizabeth-forward-media-center/): Elizabeth Forward High School’s library, which includes non-traditional library technologies including a café, stage, board games, video games, and a video studio.

...
Responding to a call from teachers for more meaningful professional development, the Allegheny Intermediate Unit ([AIU](http://remakelearning.org/organization/aiu/)), a local education service agency, created [transformED](http://remakelearning.org/project/transformed/), and in the process flipped professional development on its head. Through engaging, interactive, and creative sessions, teachers learn innovative instructional practices, explore these new teaching methods, play with new products, software, and tools they might use in their classrooms, and understand curricula. It’s a space where teachers can engage with one another to learn how they might integrate novel teaching approaches into their classroom practice.

“We’re not sitting people in rows. We really want to engage them in a fun, hands-on way,” says [Rosanne Javorsky](http://remakelearning.org/person/javorsky-rosanne/), Assistant Executive Director of Teaching & Learning at the AIU. “It’s OK to make mistakes in here. It’s OK to say, ’Hey, I don’t know how to do this.’ We want teachers to step outside their comfort zone. And we want to help them work through it.”
...
transformED offers teachers opportunities to work with ed-tech tools like [MaKey MaKey](http://remakelearning.org/resource/makey-makey/), [Gigapan](http://www.gigapan.com/), 3-D Printers, and [Hummingbird Robotics Kits](http://remakelearning.org/resource/hummingbird/). Session facilitators are not only professional development consultants; rather they are technologists, scientists, artists, designers, makers, teachers, and even students.

The boundaries between presenters and teachers quickly dissolve during interactive sessions.

“It just happens,” says [Megan Cicconi](http://remakelearning.org/person/cicconi-megan/), AIU’s Director of Instructional Innovation, who works closely with teachers and trainers in transformED. “It’s just a very collaborative space that lends itself to exploratory learning.”
...
Innovative professional development was a topic of discussion in the [Remake Learning Network](http://remakelearning.org) years before transformED first launched in February 2013. At Making Sparks 2010, a network event convening members to generate ideas for new projects, at least three discussion groups sketched plans for a “digital playground for teachers.” Recognizing the growing demand among network members, regional funders enthusiastically support AIU’s efforts to turn these ideas into reality with transformED.

**National partnerships connect network members to unique opportunities. (Coordinate)**

AIU uses transformED to host new professional development initiatives in coordination with national organizations like [Common Sense Media](http://remakelearning.org/organization/common-sense-media/), which hosts regular “Appy Hours” in the space for teachers to try the latest in educational software, and the [Institute of Play](http://remakelearning.org/organization/institute-of-play/), which hosts its annual [TeacherQuest](http://remakelearning.org/project/teacherquest/), helps dozens of Pittsburgh teachers design new games and game-like learning experiences.

## Persons of Interest

### Linda Hippert

![Linda Hippert](../docs/images/headshots/hippert-linda_300x200.jpg)
...
![Rosanne Javorsky](../docs/images/headshots/javorsky-rosanne_300x200.jpg)
...
If you’re interested in learning more about transformED, contact [Megan Cicconi](http://remakelearning.org/person/cicconi-megan/).
...
- [**Center for Creativity**](http://centerforcreativity.net/): transformED’s parent organization; an initiative of The Allegheny Intermediate Unit working to connect creative resources with educators.
...
- [**Project Zero at Quaker Valley**](http://www.qvsd.org/page.cfm?p=6189): A research project designed to study and improve education in the arts.
